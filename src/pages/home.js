        ...
        <div className="max-width text-center w-full">
            ...
            <div className="service-content  mt-8">
              <div className="top-content flex   mx-3 w-full justify-around ">
                ...
                <div className="service-elements">
                    <img src="/images/Graphic-design.png" alt="#" className=""/>
                    <h1>Graphic Design</h1>
                </div>
                <div className="service-elements">
                    <img src="/images/Content-writing.png" alt="#" className=""/>
                    <h1>Content Writing</h1>
                </div>
                <div className="service-elements">
                    <img src="/images/Web-Development.png" alt="#" className=""/>
                    <h1>Web Development</h1>
                </div>
              </div>
              <div className="bottom-content flex my-4  mx-3 w-full justify-around">
              <div className="service-elements">
                    <img src="/images/Digital-marketing.png" alt="#" className=""/>
                    <h1>Digital Marketing</h1>
                </div>
                <div className="service-elements">
                    <img src="/images/Web-Hosting.png" alt="#" className=""/>
                    <h1>Web Hosting</h1>
                </div>
                <div className="service-elements">
                    <img src="/images/Search-engine-optimiztion.png" alt="#" className=""/>
     ...
     <section className="projects   ">
        ...
        <div className="projects-content flex">
            <div className="projects-container mx-3  ">
                <img src="/images/project-list-1.png" className="border-[3px] border-primary"  alt="#"/>
                <p className="project-text ">ONLINE SHOPPING WEBSITE</p>
            </div>
            <div className="projects-container mx-3 ">
                <img src="/images/project-list-2.jpeg" className="border-[3px] border-primary" alt="#"/>
                <p className="project-text ">FASHION WEBSITE</p>
            </div>
            <div className="projects-container mx-3 ">
                <img src="/images/project-list-3.jpg" className="border-[3px] border-primary"  alt="#"/>
     ...
     <section className=" tech ">
        <div className="max-width w-full flex">
            <div className="left-content  w-1/2">
                <img src="/images/Tech-Known.png" alt="#"/>
            </div>
            ...
            <ul className="technology-known text-white text-start px-10 flex relative top-10 w-full mt-[40px] h-[200px]">
              <div className="cont-1 w-1/2 me-5">
                    <li><img src="/images/Vector.png" alt="#" />React Js</li>
                    <li><img src="/images/Vector.png" alt="#" />Node Js</li>
                    <li><img src="/images/Vector.png" alt="#" />Express Js</li>
                    <li><img src="/images/Vector.png" alt="#" />Mongo DB</li>
                    </div>
                    <div className="cont-2 w-1/2 ms-5">
                    <li><img src="/images/Vector.png" alt="#" />Tailwindcss</li>
                    <li><img src="/images/Vector.png" alt="#" />Adobe</li>
                    <li><img src="/images/Vector.png" alt="#" />Canva</li></div>
                </ul>
